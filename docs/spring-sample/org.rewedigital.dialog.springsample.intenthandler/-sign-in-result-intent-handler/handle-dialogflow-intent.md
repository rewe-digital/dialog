[spring-sample](../../index.md) / [org.rewedigital.dialog.springsample.intenthandler](../index.md) / [SignInResultIntentHandler](index.md) / [handleDialogflowIntent](./handle-dialogflow-intent.md)
