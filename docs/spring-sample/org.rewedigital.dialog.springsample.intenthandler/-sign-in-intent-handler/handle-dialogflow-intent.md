[spring-sample](../../index.md) / [org.rewedigital.dialog.springsample.intenthandler](../index.md) / [SignInIntentHandler](index.md) / [handleDialogflowIntent](./handle-dialogflow-intent.md)
